    ...
    <div class="body">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="input-group">
                ...
                <div class="form-line">
                    <input type="text" class="form-control" name="name" placeholder="Name" required autofocus value="{{ old('name') }}">
                </div>
            ...
            <div class="input-group">
                ...
                <div class="form-line">
                    <input type="date" class="form-control" name="age" placeholder="Birthday" value="{{ old('age') }}" required>
                </div>
